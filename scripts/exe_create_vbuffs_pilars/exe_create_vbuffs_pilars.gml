function exe_create_vbuffs_pilars()
{
	...
	var _lpack = ["vbuff_pilar_01_colider",vbuff_pilar_01_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_pilar_01_show",vbuff_pilar_01_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_pilar_02_colider",vbuff_pilar_02_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_pilar_02_show",vbuff_pilar_02_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_pilar_03_colider",vbuff_pilar_03_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_pilar_03_show",vbuff_pilar_03_show]; array_push(all_vbuff_list,_lpack);
