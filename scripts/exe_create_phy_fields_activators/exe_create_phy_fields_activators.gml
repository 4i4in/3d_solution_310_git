function exe_create_phy_fields_activators()
{
	...
	var _lpack = ["vbuff_gfield_1x1x1_colider",vbuff_gfield_1x1x1_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_1x1x1_show",vbuff_gfield_1x1x1_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_2x2x1_colider",vbuff_gfield_2x2x1_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_2x2x1_show",vbuff_gfield_2x2x1_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_2x2x2_colider",vbuff_gfield_2x2x2_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_2x2x2_show",vbuff_gfield_2x2x2_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_3x3x1_colider",vbuff_gfield_3x3x1_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_3x3x1_show",vbuff_gfield_3x3x1_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_4x4x1_colider",vbuff_gfield_4x4x1_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_4x4x1_show",vbuff_gfield_4x4x1_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_5x5x1_colider",vbuff_gfield_5x5x1_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_gfield_5x5x1_show",vbuff_gfield_5x5x1_show]; array_push(all_vbuff_list,_lpack);
