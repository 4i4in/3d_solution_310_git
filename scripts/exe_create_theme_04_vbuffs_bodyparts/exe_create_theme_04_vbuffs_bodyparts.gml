function exe_create_theme_04_vbuffs_bodyparts()
{
	...
	var _lpack = ["Uarm_R_01_theme_04",Uarm_R_01_theme_04]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Uarm_L_01_theme_04",Uarm_L_01_theme_04]; array_push(all_vbuff_list,_lpack);
