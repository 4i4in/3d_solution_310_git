function exe_create_vbuffs_floors()
{
	...
	var _lpack = ["vbuff_floor_3x3_01_colider",vbuff_floor_3x3_01_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_3x3_01_show",vbuff_floor_3x3_01_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_5x5_01_colider",vbuff_floor_5x5_01_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_5x5_01_show",vbuff_floor_5x5_01_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_5x5_02_colider",vbuff_floor_5x5_02_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_5x5_02_show",vbuff_floor_5x5_02_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_5x5_03_colider",vbuff_floor_5x5_03_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_5x5_03_show",vbuff_floor_5x5_03_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_5x5_03a_show",vbuff_floor_5x5_03a_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_d5_01_colider",vbuff_floor_d5_01_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_floor_d5_01_show",vbuff_floor_d5_01_show]; array_push(all_vbuff_list,_lpack);
