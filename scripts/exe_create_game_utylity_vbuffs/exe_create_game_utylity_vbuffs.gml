function exe_create_game_utylity_vbuffs()
{
	...
	var _lpack = ["vbuff_camera_01",vbuff_camera_01]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_pntrdir_01",vbuff_pntrdir_01]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_big_pointer",vbuff_big_pointer]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_pointer_orange",vbuff_pointer_orange]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_pointer_green",vbuff_pointer_green]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["main_part_01",main_part_01]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["main_part_low",main_part_low]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["main_part_total",main_part_total]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_direction_sign_01",vbuff_direction_sign_01]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_dir_arrow2",vbuff_dir_arrow2]; array_push(all_vbuff_list,_lpack);
	var _lpack = ["vbuff_dir_arrow2_x01",vbuff_dir_arrow2_x01]; array_push(all_vbuff_list,_lpack);
	var _lpack = ["vbuff_dir_arrow2_x05",vbuff_dir_arrow2_x05]; array_push(all_vbuff_list,_lpack);
	var _lpack = ["vbuff_dir_arrow2_x20",vbuff_dir_arrow2_x20]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_refsigns500",vbuff_refsigns500]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_refsigns500_xyz",vbuff_refsigns500_xyz]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_conector_1",vbuff_conector_1]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_conector_2",vbuff_conector_2]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_conector_3",vbuff_conector_3]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_conector_4",vbuff_conector_4]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_conector_5",vbuff_conector_5]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_conector_6",vbuff_conector_6]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_conector_7",vbuff_conector_7]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_conector_8",vbuff_conector_8]; array_push(all_vbuff_list,_lpack);
