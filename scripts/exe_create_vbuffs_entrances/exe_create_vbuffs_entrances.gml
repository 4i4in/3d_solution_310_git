function exe_create_vbuffs_entrances()
{
	...
	var _lpack = ["vbuff_entrance_01_5x5_colider",vbuff_entrance_01_5x5_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_entrance_01_5x5_show",vbuff_entrance_01_5x5_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_entrance_02_5x5_colider",vbuff_entrance_02_5x5_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_entrance_02_5x5_show",vbuff_entrance_02_5x5_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_entrance_03_5x5_colider",vbuff_entrance_03_5x5_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_entrance_03_5x5_show",vbuff_entrance_03_5x5_show]; array_push(all_vbuff_list,_lpack);
