function exe_create_basic_doors_and_activators()
{
	...
	var _lpack = ["vbuff_doors_1",vbuff_doors_1]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1a",vbuff_doors_1a]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1b",vbuff_doors_1b]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1c",vbuff_doors_1c]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1c_colider",vbuff_doors_1c_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1d",vbuff_doors_1d]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1b_colider_around",vbuff_doors_1b_colider_around]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1b_show_around",vbuff_doors_1b_show_around]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1d_show_around",vbuff_doors_1d_show_around]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1b_colider_around_small",vbuff_doors_1b_colider_around_small]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1b_show_around_small",vbuff_doors_1b_show_around_small]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors_1d_show_around_small",vbuff_doors_1d_show_around_small]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_doors1_activator2_small",vbuff_doors1_activator2_small]; array_push(all_vbuff_list,_lpack);
