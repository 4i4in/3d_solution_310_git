function exe_create_standard_shields()
{
	...
	var _lpack = ["shield1",shield1]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["shield1_colider",shield1_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["shield2",shield2]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["shield2_colider",shield2_colider]; array_push(all_vbuff_list,_lpack);
