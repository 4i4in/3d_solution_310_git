function exe_create_vbuffs_open_walls()
{
	...
	var _lpack = ["vbuff_wall_01_w4h3_sdoor_colider",vbuff_wall_01_w4h3_sdoor_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wall_01_w4h3_sdoor_show",vbuff_wall_01_w4h3_sdoor_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wall_03_w4h3_sdoor_show",vbuff_wall_03_w4h3_sdoor_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wall_01_w4h3_colider",vbuff_wall_01_w4h3_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wall_01_w4h3_show",vbuff_wall_01_w4h3_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wall_03_w4h3_show",vbuff_wall_03_w4h3_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wall_01_w4h3_broken_colider",vbuff_wall_01_w4h3_broken_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wall_01_w4h3_broken_show",vbuff_wall_01_w4h3_broken_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wall_03_w4h3_broken_show",vbuff_wall_03_w4h3_broken_show]; array_push(all_vbuff_list,_lpack);
