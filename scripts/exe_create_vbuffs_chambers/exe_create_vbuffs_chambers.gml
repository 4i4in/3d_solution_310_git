function exe_create_vbuffs_chambers()
{
	...
	var _lpack = ["vbuff_chamber_3x3h1_colider",vbuff_chamber_3x3h1_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_chamber_3x3h1_show",vbuff_chamber_3x3h1_show]; array_push(all_vbuff_list,_lpack);
