function exe_create_vbuffs_decorations()
{
	...
	var _lpack = ["vbuff_deco_ent_5x5_01",vbuff_deco_ent_5x5_01]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_deco_ent_5x5_03",vbuff_deco_ent_5x5_03]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_deco_floor_5x5_01",vbuff_deco_floor_5x5_01]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_deco_floor_5x5_03",vbuff_deco_floor_5x5_03]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_deadend_2x2_01_colider",vbuff_deadend_2x2_01_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_deadend_2x2_01_show",vbuff_deadend_2x2_01_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_deadend_2x2_03_show",vbuff_deadend_2x2_03_show]; array_push(all_vbuff_list,_lpack);
