function exe_create_theme_03_vbuffs_bodyparts()
{
	...
	var _lpack = ["shoulder_R_01_theme_03",shoulder_R_01_theme_03]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Uarm_R_01_theme_03",Uarm_R_01_theme_03]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["shoulder_L_01_theme_03",shoulder_L_01_theme_03]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Uarm_L_01_theme_03",Uarm_L_01_theme_03]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Lleg_R_01_theme_03",Lleg_R_01_theme_03]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Lleg_L_01_theme_03",Lleg_L_01_theme_03]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["head_01_theme_03",head_01_theme_03]; array_push(all_vbuff_list,_lpack);
