function exe_create_theme_02_vbuffs_bodyparts()
{
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["spine_01_theme_02",spine_01_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["spine_02_theme_02",spine_02_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["neck_01_theme_02",neck_01_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["neck_01_theme_02_heroic",neck_01_theme_02_heroic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["head_01_theme_02",head_01_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["jaw_01_theme_02",jaw_01_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["shoulder_R_01_theme_02",shoulder_R_01_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Uarm_R_01_theme_02",Uarm_R_01_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["shoulder_L_01_theme_02",shoulder_L_01_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Uarm_L_01_theme_02",Uarm_L_01_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Lleg_R_01_theme_02",Lleg_R_01_theme_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Lleg_L_01_theme_02",Lleg_L_01_theme_02]; array_push(all_vbuff_list,_lpack);
