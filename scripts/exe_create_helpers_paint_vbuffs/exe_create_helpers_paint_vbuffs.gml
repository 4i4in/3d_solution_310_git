function exe_create_helpers_paint_vbuffs()
{
	...
	var _lpack = ["vbuff_helper_gras_01_d100",vbuff_helper_gras_01_d100]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_helper_gras_01_d250",vbuff_helper_gras_01_d250]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_helper_gras_01_d500",vbuff_helper_gras_01_d500]; array_push(all_vbuff_list,_lpack);
