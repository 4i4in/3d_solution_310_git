function exe_create_basic_vbuffs_bodyparts()
{
	...
	var _lpack = ["ass_pivot_01_basic",ass_pivot_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["spine_01_basic",spine_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["spine_02_basic",spine_02_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["neck_01_basic",neck_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["head_01_basic",head_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["jaw_01_basic",jaw_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["shoulder_R_01_basic",shoulder_R_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Uarm_R_01_basic",Uarm_R_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Farm_R_01_basic",Farm_R_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["hand_R_01_basic",hand_R_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["shoulder_L_01_basic",shoulder_L_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Uarm_L_01_basic",Uarm_L_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Farm_L_01_basic",Farm_L_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["hand_L_01_basic",hand_L_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["hip_R_01_basic",hip_R_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Uleg_R_01_basic",Uleg_R_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Lleg_R_01_basic",Lleg_R_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["foot_R_01_basic",foot_R_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["toe_R_01_basic",toe_R_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["hip_L_01_basic",hip_L_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Uleg_L_01_basic",Uleg_L_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["Lleg_L_01_basic",Lleg_L_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["foot_L_01_basic",foot_L_01_basic]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["toe_L_01_basic",toe_L_01_basic]; array_push(all_vbuff_list,_lpack);
