function exe_create_vbuffs_stones()
{
	...
	var _lpack = ["vbuff_stone_01_colider",vbuff_stone_01_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_01_show",vbuff_stone_01_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_02_colider",vbuff_stone_02_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_02_show",vbuff_stone_02_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_03_colider",vbuff_stone_03_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_03_show",vbuff_stone_03_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_04_colider",vbuff_stone_04_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_04_show",vbuff_stone_04_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_05_colider",vbuff_stone_05_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_05_show",vbuff_stone_05_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_06_colider",vbuff_stone_06_colider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_stone_06_show",vbuff_stone_06_show]; array_push(all_vbuff_list,_lpack);
}