function exe_create_vbuffs_roofroot()
{
	...
	var _lpack = ["vbuff_roofroot_01",vbuff_roofroot_01]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_roofroot_02",vbuff_roofroot_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_roofroot_03",vbuff_roofroot_03]; array_push(all_vbuff_list,_lpack);
