function exe_create_vbuffs_wallroot()
{
	...
	var _lpack = ["vbuff_wallroot_01",vbuff_wallroot_01]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wallroot_02",vbuff_wallroot_02]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wallroot_03",vbuff_wallroot_03]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wallroot_04",vbuff_wallroot_04]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_wallroot_05",vbuff_wallroot_05]; array_push(all_vbuff_list,_lpack);
