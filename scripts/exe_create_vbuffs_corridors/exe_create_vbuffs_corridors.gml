function exe_create_vbuffs_corridors()
{
	...
	var _lpack = ["vbuff_corridor_01_w3d1_collider",vbuff_corridor_01_w3d1_collider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_corridor_01_w3d1_show",vbuff_corridor_01_w3d1_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_corridor_01up_w3d1_collider",vbuff_corridor_01up_w3d1_collider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_corridor_01up_w3d1_show",vbuff_corridor_01up_w3d1_show]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_corridor_01down_w3d1_collider",vbuff_corridor_01down_w3d1_collider]; array_push(all_vbuff_list,_lpack);
	...
	buffer_delete(temp_buff_data);
	var _lpack = ["vbuff_corridor_01down_w3d1_show",vbuff_corridor_01down_w3d1_show]; array_push(all_vbuff_list,_lpack);
